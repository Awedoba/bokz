 ...
 */
router.post('/', authenticate, validate(createCollectionSchema), asyncHandler(async (req, res) => {
 ...
 * Update collection
 */
router.patch('/:id', authenticate, validate(createCollectionSchema.partial()), asyncHandler(async (req, res) => {
 ...
 */
router.post('/:id/books', authenticate, asyncHandler(async (req, res) => {
 ...
 */
router.delete('/:id/books/:bookId', authenticate, asyncHandler(async (req, res) => {
